...
# Store the data in the requested variables
images = train_images
labels = to_categorical(train_labels)  # Convert labels to one-hot encoded format
...
cnn_data.train(images, labels, test_images, test_labels, batch_size=128, epochs=2)
